...
public class MainActivity extends AppCompatActivity {
    ...
    private void ValidarCampos(){
        ...
        if(resultadoNome = isCampoVazio(nome)){
            ...
            Toast.makeText(MainActivity.this,"digite um nome", Toast.LENGTH_LONG).show();
        }
...
//         Validação do campo cSenha
            ...
            Toast.makeText(MainActivity.this,"Senhas não conferem!", Toast.LENGTH_LONG).show();
